...
def test_generate_access_token(master_auth_use_cases,
                               settings):
    master_id = 1

    token = master_auth_use_cases.generate_access_token(master_id)
...
def test_get_master_id_from_access_token(master_auth_use_cases, settings):
    master_id = str(1)
    ...
    decoded_id = master_auth_use_cases.get_master_id_from_access_token(token)
